...
struct freememory *GetPart(struct freememory *pBegin,
                           struct freememory *pEnd, int type) {
...
bool recycle(int start, int size) {
